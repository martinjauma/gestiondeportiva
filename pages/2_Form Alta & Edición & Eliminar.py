...
def eliminar_registro(id_unico):
    ...
    guardar_datos(datos)
    st.success(f"Registro: {nuevo_apellido}, {nuevo_nombre} fue eliminado correctamente.")
...
def editar_registro(id_unico, nuevo_apellido, nuevo_nombre):
    ...
    guardar_datos(datos)
    st.success(f"Registro: {nuevo_apellido}, {nuevo_nombre} fue editado correctamente.")

# ----------------------------------------------------------

st.title("Formulario de Edición")
...
# Funcionalidad de búsqueda y edición/eliminación
st.subheader("Buscar y Editar/Eliminar Registros")
